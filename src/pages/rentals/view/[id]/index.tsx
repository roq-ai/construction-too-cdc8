                ...
                <FormListItem
                  ...
                  text={
                    data?.rental_start_date
                      ? format(parseISO(data?.rental_start_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
                ...
                <FormListItem
                  ...
                  text={
                    data?.rental_end_date
                      ? format(parseISO(data?.rental_end_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
                  ...
                  <FormListItem
                    ...
                    text={
                      <Link as={NextLink} href={`/customers/view/${data?.customer?.id}`}>
                        {data?.customer?.rental_start_date}
                      </Link>
                    }
                  />
                )}
